...
class EmonHubInterfacer(threading.Thread):
    ...
    def _open_serial_port(self, com_port, com_baud):
        ...
        try:
            ...
            self._log.error(e)
            raise EmonHubModuleInitError('Could not open COM port %s' %
                                           com_port)
        else:
            return s
    ...
    def _open_socket(self, port_nb):
        ...
        try:
            ...
            self._log.error(e)
            raise EmonHubModuleInitError('Could not open port %s' %
                                           port_nb)
        else:
            return s
...
class EmonHubModuleInitError(Exception):
    pass
